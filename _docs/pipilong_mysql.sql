...
-- ----------------------------
INSERT INTO `database_info` VALUES (1240625039548657665, 'master', 'com.mysql.cj.jdbc.Driver', 'root', '123456', 'jdbc:mysql://39.106.167.223:3306/petcage?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT', '主数据源，项目启动数据源！', '2020-03-19 21:03:53');
...
INSERT INTO `sys_config` VALUES (1143468689664876546, '管理系统名称', 'GUNS_SYSTEM_NAME', 'N', NULL, '皮皮笼后台管理平台', '管理系统名称', '2019-06-25 18:39:15', 1, NULL, NULL);
...
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1253642906988711937, 'petcage_business', '0', '[0],', '宠笼数据管理', 'layui-icon-rate-half', '#', 15, 1, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-24 19:12:15', '2020-04-24 22:04:15', 1, 1);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1253685412203978753, 'petcage_user', 'petcage_business', '[0],[petcage_business],', '用户表', 'layui-icon-username', '/petcage/user', 41, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-24 22:01:09', '2020-04-25 09:36:07', 1, 1);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1253686049914347521, 'petcage_pet', 'petcage_business', '[0],[petcage_business],', '宠物表', 'layui-icon-face-surprised', '/petcage/pet', 42, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-24 22:03:41', '2020-04-25 09:36:17', 1, 1);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1254321286646194177, 'app_info', 'petcage_business', '[0],[petcage_business],', '应用信息', 'layui-icon-star-fill', '/petcage/app_info', 43, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-26 16:07:54', NULL, 1, NULL);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1254324457208578049, 'damage_type', 'petcage_business', '[0],[petcage_business],', '故障类型', 'layui-icon-star-fill', '/petcage/damage_type', 44, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-26 16:20:29', NULL, 1, NULL);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1254328377200902145, 'petcage_device', 'petcage_business', '[0],[petcage_business],', '设备', 'layui-icon-star-fill', '/petcage/device', 45, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-26 16:36:04', NULL, 1, NULL);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1254331019000053762, 'dim_pet', 'petcage_business', '[0],[petcage_business],', '宠物种类', 'layui-icon-star-fill', '/petcage/dim_pet', 46, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-26 16:46:34', NULL, 1, NULL);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1254334332873506818, 'petcage_feedback', 'petcage_business', '[0],[petcage_business],', '反馈', 'layui-icon-star-fill', '/petcage/feedback', 47, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-26 16:59:44', NULL, 1, NULL);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1254334574188593153, 'petcage_order', 'petcage_business', '[0],[petcage_business],', '订单', 'layui-icon-star-fill', '/petcage/order', 48, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-26 17:00:42', NULL, 1, NULL);
INSERT INTO `petcage`.`sys_menu`(`menu_id`, `code`, `pcode`, `pcodes`, `name`, `icon`, `url`, `sort`, `levels`, `menu_flag`, `description`, `status`, `new_page_flag`, `open_flag`, `system_type`, `create_time`, `update_time`, `create_user`, `update_user`) VALUES (1254339978419273730, 'petcage_user_type', 'petcage_business', '[0],[petcage_business],', '用户类型字典', 'layui-icon-star-fill', '/petcage/user_type', 49, 2, 'Y', NULL, 'ENABLE', NULL, NULL, 'BASE_SYSTEM', '2020-04-26 17:22:10', NULL, 1, NULL);
...
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1, 1253642906988711937, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1253685412296253442, 1253685412203978753, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1253686049977262081, 1253686049914347521, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1254321286742663169, 1254321286646194177, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1254324457305047041, 1254324457208578049, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1254328377259622402, 1254328377200902145, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1254331019096522754, 1254331019000053762, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1254334333049667586, 1254334332873506818, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1254334574247313409, 1254334574188593153, 1);
INSERT INTO `petcage`.`sys_relation`(`relation_id`, `menu_id`, `role_id`) VALUES (1254339978482188290, 1254339978419273730, 1);

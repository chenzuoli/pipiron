layui.use(['table', 'ax', 'func'], function () {
    ...
    DictType.initColumn = function () {
        return [[
            ...
            {field: 'code', align: "center", sort: true, title: '用户类型id'},
            {field: 'name', align: "center", sort: true, title: '用户类型名称'},
    ...
    DictType.openAddDlg = function () {
        func.open({
            height: 630,
            title: '添加用户类型',
            content: Feng.ctxPath + '/petcage/user_type/add',
    ...
    DictType.openEditDlg = function (data) {
        func.open({
            height: 630,
            title: '修改用户类型信息',
            content: Feng.ctxPath + '/petcage/user_type_edit?id=' + data.id,
            tableId: DictType.tableId
        });
    };
    ...
    DictType.onDeleteItem = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/petcage/user_type/delete", function (data) {
                Feng.success("删除成功!");
                table.reload(DictType.tableId);
            }, function (data) {
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/petcage/user_type_list',
        page: true,
        height: "full-98",
        cellMinWidth: 150,

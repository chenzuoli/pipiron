layui.use(['table', 'ax', 'func'], function () {
    ...
    DictType.initColumn = function () {
        return [[
            ...
            {field: 'variety', align: "center", sort: true, title: '宠物种类'},
            {field: 'size', align: "center", sort: true, title: '大小'},
    ...
    DictType.openAddDlg = function () {
        func.open({
            height: 630,
            title: '添加宠物种类',
            content: Feng.ctxPath + '/petcage/dim_pet/add',
    ...
    DictType.openEditDlg = function (data) {
        func.open({
            height: 630,
            title: '修改宠物种类信息',
            content: Feng.ctxPath + '/petcage/dim_pet_edit?id=' + data.id,
            tableId: DictType.tableId
        });
    };
    ...
    DictType.onDeleteItem = function (data) {
        var operation = function () {
            var ajax = new $ax(Feng.ctxPath + "/petcage/dim_pet/delete", function (data) {
                Feng.success("删除成功!");
                table.reload(DictType.tableId);
            }, function (data) {
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/petcage/dim_pet_list',
        page: true,
        height: "full-98",
        cellMinWidth: 150,
